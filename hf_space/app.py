#!/usr/bin/env python3
"""
SAGE AI Inference Server — For Hugging Face Spaces Deployment

YOLOv8m object detection with thermal image enhancement.
Exposes /detect and /health endpoints via Flask.
...
if __name__ == "__main__":
    load_model("yolov8m.pt")

    port = 7860  # HF Spaces default port
    print(f"\n[SAGE-AI] Inference server running on http://0.0.0.0:{port}")
